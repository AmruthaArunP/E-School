...
function docReady() {
	...
	$('#airporttab a:first').tab('show');
    $('#airporttab a').click(function (e) {
        e.preventDefault();
        $(this).tab('show');
    });
...
$(document).ready(function(){
    ...
    $(".add-more").click(function(e){
        ...
        next = next + 1;
        var newIn = '<input autocomplete="off" class="input form-control" placeholder="Section" id="field' + next + '" name="section[]" type="text">';
        var newInput = $(newIn);
